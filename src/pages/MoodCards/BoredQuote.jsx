...
const BoredQuote = () => {
  ...
  return (
    <div style={wrapper}>
      <div style={card}>
        <h2>🐷 Let’s shake things up!</h2>
        <p>"Boredom always comes before creativity."</p>
        <img src="/bored.jpg" alt="bored" style={imgStyle} />
        <Buttons mood="bored" navigate={navigate} />
      </div>
    </div>
  );
};

export default BoredQuote;
const wrapper = {
  display: 'flex',
