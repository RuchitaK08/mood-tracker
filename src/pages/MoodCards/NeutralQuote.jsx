...
const NeutralQuote = () => {
  ...
  return (
    <div style={wrapper}>
      <div style={card}>
        <h2>🐙 It’s okay to just *be*</h2>
        <p>"Even calm seas have depth."</p>
        <img src="/neutral.jpg" alt="neutral" style={imgStyle} />
        <Buttons mood="neutral" navigate={navigate} />
      </div>
    </div>
  );
};

export default NeutralQuote;
const wrapper = {
  display: 'flex',
